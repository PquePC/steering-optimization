...
| [30](30-m2-m3-seam-audit.md) | Audit the whole M2/M3 seam | M3 reuses M2's hook, generation, judge transport and I/O. Five wiring defects found so far, three of them by accident. The general form is a value M3 owns that some M2 path reads from somewhere else | PENDING — after the first M3 run |
